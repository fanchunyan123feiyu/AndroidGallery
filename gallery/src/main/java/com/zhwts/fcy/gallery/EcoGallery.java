...
public class EcoGallery extends EcoGalleryAbsSpinner implements GestureDetector.OnGestureListener {
    ...
    private void scrollIntoSlots() {
       ...
       // Log.e("TAG", "2222" + mSelectedChild);
        ...
        selectedCenter1=selectedCenter;
         Log.e("TAG", "选中的position" + selectedCenter);
    ...
    private boolean dispatchLongPress(View view, int position, long id) {
        ...
        if (!handled) {
            mContextMenuInfo = new EcoGalleryAdapterView.AdapterContextMenuInfo(view, position, id);
